...
type ProxyPoolStrategy = internalconfig.ProxyPoolStrategy
...
const (
	...
	ProxyPoolModeRandom              = internalconfig.ProxyPoolModeRandom
	ProxyPoolModeRotate              = internalconfig.ProxyPoolModeRotate
	DefaultProxyPoolRequestsPerProxy = internalconfig.DefaultProxyPoolRequestsPerProxy
)
