...
const sidebarIcons: Record<string, ReactNode> = {
  ...
  requestLogs: <IconSidebarRequestLogs size={18} />,
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          defaultMeta: 'Auth 文件与凭证',
          icon: sidebarIcons.authFiles,
        },
        {
          path: '/oauth',
          labelKey: 'nav.oauth',
          defaultLabel: 'OAuth 登录',
          metaKey: 'nav_meta.oauth',
          defaultMeta: 'OAuth 授权登录',
      ...
      items: [
        {
          ...
          defaultMeta: 'API Key 与限额',
          icon: sidebarIcons.quota,
        },
        {
          path: '/request-logs',
          labelKey: 'nav.request_logs',
          defaultLabel: '请求日志',
          metaKey: 'nav_meta.request_logs',
          defaultMeta: 'Token 与代理追踪',
          icon: sidebarIcons.requestLogs,
        },
            ...
            {navGroups.map((group, idx) => (
              <div className="nav-group" key={group.id}>
                ...
                {group.items.map((item) => {
                  const itemLabel = t(item.labelKey, { defaultValue: item.defaultLabel });
                  return (
                    <NavLink
                      key={item.path}
                      to={item.path}
                      ...
                      {showSidebarLabels && (
                        <span className="nav-text">
                          ...
                          <span className="nav-meta">
                            {t(item.metaKey, { defaultValue: item.defaultMeta })}
                          </span>
                        </span>
                      )}
                    </NavLink>
